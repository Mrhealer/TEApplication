...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mMarkerSize = typedArray.getDimensionPixelSize(R.styleable.TimelineView_markerSize, TimelineViewUtils.dpToPx(20, getContext()));
        ...
        mLineWidth = typedArray.getDimensionPixelSize(R.styleable.TimelineView_lineWidth, TimelineViewUtils.dpToPx(2, getContext()));
        ...
        mLineStyleDashLength = typedArray.getDimensionPixelSize(R.styleable.TimelineView_lineStyleDashLength, TimelineViewUtils.dpToPx(8f, getContext()));
        mLineStyleDashGap = typedArray.getDimensionPixelSize(R.styleable.TimelineView_lineStyleDashGap, TimelineViewUtils.dpToPx(4f, getContext()));
        typedArray.recycle();
